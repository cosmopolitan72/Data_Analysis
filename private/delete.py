...
d
        ...
        print("잘못된 입력입니다. 띄어 쓰쓰기 포함해서 다시 입력하세요.\n")
 """
                        ...
                        while True: 
                            ...
                            if Suppresion_Type in ['2', " 부분 삭제", "2. 부분 삭제"]:
                                ...
                                def partial_delete_column(alias_df):
                                    ...
                                    alias_df[column_name] = alias_df[column_name].astype(str).str.slice(0, cut_index) + masking_text
                                    print(f"'{column_name}' 마스킹되었습니다.")
